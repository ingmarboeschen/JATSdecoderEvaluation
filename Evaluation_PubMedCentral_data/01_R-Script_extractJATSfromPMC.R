...
##################################################################################
## This script extracts and stores the NISO-JATS tags from all PubMed Central 
## files. The full repository of PMC linked open access articles is downloadable 
## via PMCs bulk download server: ftp://ftp.ncbi.nlm.nih.gov/pub/pmc/oa_bulk 
###########################################################################
...
################################################################################
## Extraction of JATS tags with JATSdecoder with article batch size = BatchSize
###############################################################################
# load libraries
